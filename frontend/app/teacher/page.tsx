...
export default function TeacherPage() {
  ...
  ========================= */
  return (
    <div className="min-h-screen bg-[#9FB89C] p-4 text-[#102A1E]">
      <ConnectionStatus />

      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="bg-[#CFEFD6] rounded-xl p-6 mb-6 border-2 border-[#234734] shadow-sm">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            {teacherId && (
              <div className="bg-[#E6F4EA] px-4 py-2 rounded-lg border-2 border-[#4CAF50] text-sm font-semibold">
        ...
        <div className="flex gap-2 mb-6 border-b pb-2">
          {["chat", "history", "resources"].map((tab) => (
            <button
              ...
              className={`px-4 py-2 rounded-t-lg border-2 border-b-0 ${
                  activeTab === tab
                  ? "bg-[#CFEFD6] font-bold border-[#234734] text-[#234734]"
                  : "bg-[#F4F7F4] border-[#234734] hover:bg-[#E6F4EA] text-[#234734]"
            }`}
        ...
        {/* CHAT */}
        {activeTab === "chat" && (
          <div className="bg-[#CFEFD6] rounded-xl border-2 border-[#234734] p-4 shadow-sm">
                ...
                >
                  <div
                    className={`max-w-[75%] p-3 rounded-lg ${
                      m.sender === "user"
                        ? "bg-[#FFFDCE] border border-black-200"
                        : "bg-[#FFFDCE] border border-black-200"
                    }`}
                  >
            ...
            <div className="mt-4 flex gap-2">
              ...
              <button
                ...
                className="bg-[#4CAF50] hover:bg-[#3E8E41] text-black px-4 py-2 rounded-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
